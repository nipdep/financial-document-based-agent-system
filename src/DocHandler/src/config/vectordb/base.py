...
class BaseVectorDbConfig(BaseConfig):
    def __init__(
        ...
        **kwargs,
        ...
        :param host: Database connection remote host. Use this if you run Chatgenie as a client, defaults to None
        :type host: Optional[str], optional
        :param host: Database connection remote port. Use this if you run Chatgenie as a client, defaults to None
